...
import GroupDb from './lib/database/models/sai-groups.js'
...
export async function handler(conn, rawM) {
  ...
  if (m.isGroup && groupDb) {
    ...
    const isBypass = ['Saidespierta', 'Saiduerme', 'bot', 'boton', 'botoff', 'setprimary', 'principal', 'onlyadmin', 'soloadmin', 'adminonly'].includes(cmdUsado)
